...
const Kids_wear = ({ handleOrderPopup }) => {
  ...
  useEffect(() => {
    const fetchImages = async () => {
      try {
        const response = await fetch('https://api.pexels.com/v1/search?query=kids+wear', {
          method: 'GET',
          headers: {
    ...
    <div className="container">
      ...
      <div className="text-center mt-[30px] mb-[100px] max-w-[600px] mx-auto">
        ...
        <p data-aos="fade-up" className="text-xs text-gray-400">
          Browse through the latest kids wear styles for a fashionable and comfortable look.
        </p>
      </div>

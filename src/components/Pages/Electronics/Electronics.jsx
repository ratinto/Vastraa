...
function Electronics({ handleOrderPopup }) {
  ...
  useEffect(() => {
    const fetchImages = async () => {
      try {
        const response = await fetch('https://api.pexels.com/v1/search?query=electronics', {
          method: 'GET',
          headers: {
        ...
        setImages(data.photos); // Set the images for electronics
      } catch (error) {
    ...
    <div className="container">
      ...
      <div className="text-center mt-[30px] mb-[100px] max-w-[600px] mx-auto">
        ...
        <p data-aos="fade-up" className="text-xs text-gray-400">
          Browse the latest in electronics, from gadgets to home appliances.
        </p>
      </div>
